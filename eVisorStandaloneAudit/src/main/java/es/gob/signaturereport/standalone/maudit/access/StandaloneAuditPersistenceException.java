 ...
 * @version 1.0, 20/07/2011.
 */
public class StandaloneAuditPersistenceException extends Exception {
	 ...
	 */
	public StandaloneAuditPersistenceException(int errorCode, String errorDescription) {
	 ...
	 */
	public StandaloneAuditPersistenceException(int errorCode, String errorDescription, Throwable cause) {
