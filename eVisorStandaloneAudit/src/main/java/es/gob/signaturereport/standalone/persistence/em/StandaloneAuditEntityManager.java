...
public final class StandaloneAuditEntityManager {
	...
	private void createEntityManagerFactory() {
		try {
			...
			//LOGGER.error(LanguageStandalone.getFormatResStandaloneAudit(StandaloneAuditLogConstants.STAND_AUDIT_LOG020, new Object[ ] { EntityManagerFactory.class.getSimpleName() }));
		}
	}
