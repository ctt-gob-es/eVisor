...
/** 
 * <b>File:</b><p>es.gob.signaturereport.maudit.log.AuditException.java.</p>
 * <b>Description:</b><p> Class that represents an error occurs into audit module.</p>
 * <b>Project:</b><p>Horizontal platform to generation signature reports in legible format.</p>
 * <b>Date:</b><p>18/07/2011.</p>
...
/** 
 * <p>Class that represents an error occurs into audit module.</p>
 * <b>Project:</b><p>Horizontal platform to generation signature reports in legible format.</p>
 * @version 1.0, 18/07/2011.
 */
public class AuditException extends Exception {
	 ...
	 */
	private static final long serialVersionUID = 8115166433039328038L;
	...
	/**
	 * Constructor method for the class AuditException.java.
	 * @param errorCode	Error code.
	 * @param message 	Error description.
	 */
	public AuditException(int errorCode, String message) {
		super(message);
		this.code = errorCode;
	 ...
	 */
	public AuditException(int errorCode, String message,Throwable errorCause) {
