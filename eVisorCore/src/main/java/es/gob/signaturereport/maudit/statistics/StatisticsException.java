...
/** 
 * <b>File:</b><p>es.gob.signaturereport.maudit.statistics.StatisticsException.java.</p>
 * <b>Description:</b><p>Class that represents an error occurred in statistics module.</p>
...
/** 
 * <p>Class that represents an error occurred in statistics module.</p>
 * <b>Project:</b><p>Horizontal platform to generation signature reports in legible format.</p>
 * @version 1.0, 12/08/2011.
 */
public class StatisticsException extends Exception{
	 ...
	 */
	private static final long serialVersionUID = 368515345780645279L;
	 ...
	 */
	public static final int INVALID_INPUT_PARAMETERS = 0;
	...
	/**
	 * Constructor method for the class StatisticsException.java.
	 * @param errorCode	Error code.
	 * @param message Error description.
	 */
	public StatisticsException(int errorCode, String message) {
		super(message);
		this.code = errorCode;
	 ...
	 */
	public StatisticsException(int errorCode, String message,Throwable cause) {
		super(message,cause);
		this.code = errorCode;
		this.description = message;
	}
