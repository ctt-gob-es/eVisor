...
/**
 * <b>File:</b><p>es.gob.signaturereport.mfirma.generators.P7ContentSignerParameters.java.</p>
...
public final class P7ContentSignerParameters {
	...
	public P7ContentSignerParameters(final byte[ ] content, String signatureAlgorithm, PrivateKeyEntry keyEntry) {
		...
		if (signatureAlgorithm == null || signatureAlgorithm.length() < 1) {
			throw new IllegalArgumentException(Language.getMessage(LanguageKeys.PCSP_LOG001));
		}
		GenericUtilsCommons.checkInputParameterIsNotNull(keyEntry, Language.getMessage(LanguageKeys.PCSP_LOG002));
