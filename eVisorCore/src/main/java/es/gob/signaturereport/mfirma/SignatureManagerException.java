...
/** 
 * <p>Class that contains information about an error occurred while validating or generating a signature.</p>
 * <b>Project:</b><p>Horizontal platform to generation signature reports in legible format.</p>
 * @version 1.0, 07/02/2011.
 */
public class SignatureManagerException extends Exception{
     ...
     */
    public SignatureManagerException(int errorCode,String message) {
    	super(message);
    	this.code = errorCode;
     ...
     * @param cause Error cause.
     */
    public SignatureManagerException(String message, Throwable cause) {
	super(message, cause);
    }
     ...
     */
    public SignatureManagerException(int errorCode,String message,Throwable errorCause) {
