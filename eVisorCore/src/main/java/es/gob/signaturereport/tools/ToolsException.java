...
/** 
 * <b>File:</b><p>es.gob.signaturereport.tools.ToolsException.java.</p>
...
public class ToolsException extends Exception {
	 ...
	 */
	public ToolsException(int code, String description) {
		super(description);
		this.code = code;
		this.description = description;
	}
     ...
     */
    public ToolsException(int code, String description,Throwable cause) {
