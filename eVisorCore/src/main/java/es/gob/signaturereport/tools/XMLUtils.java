...
public final class XMLUtils {
	...
	static {
		try {
			...
			LOGGER.error(Language.getMessage(LanguageKeys.UTIL_001), e);
		}
	}
	 ...
	 */
	public static Document getBlankDocument() throws ToolsException{
		try {
			return dbf.newDocumentBuilder().newDocument();
		} catch (ParserConfigurationException e) {
			String msg = Language.getMessage(LanguageKeys.UTIL_001);
			LOGGER.error(msg, e);
			throw new ToolsException(ToolsException.XML_PARSER_ERROR, msg,e);
		}
	}
	/**
	 ...
	 * @throws ToolsException	If an error occurs.
	 */
	public static byte[] getSOAP(SOAPMessage msgSOAP) throws ToolsException{
		byte[] soap = null;
		...
		try {
			...
			String msg = Language.getMessage(LanguageKeys.UTIL_039);
			LOGGER.error(msg,e);
			throw new ToolsException(ToolsException.UNKNOWN_ERROR, msg,e);
		}finally{
			UtilsResources.safeCloseOutputStream(stream);
		}
		return soap;
	}
	/**
	...
	public static byte[ ] xslTransform(byte[ ] xml, byte[ ] xslt) throws ToolsException {
		...
		try {
			...
			String msg = Language.getMessage(LanguageKeys.UTIL_007);
			LOGGER.error(msg, e);
			throw new ToolsException(ToolsException.XSL_TRANSFORM_ERROR, msg,e);
		}  finally {
	 ...
	 * @throws ToolsException	There was an error processing the XML.
	 */
	public static NodeList getNodes(Node xml, String xpath) throws ToolsException {
		try {
			return XPathAPI.selectNodeList(xml, xpath);
		} catch (TransformerException e) {
			String msg = Language.getFormatMessage(LanguageKeys.UTIL_004, new Object[ ] { xpath });
			LOGGER.error(msg, e);
	 ...
	 * @throws ToolsException	There was an error processing the XML.
	 */
	public static String getNodeValue(Node xml, String xpath) throws ToolsException {
		try {
	 ...
	 * @throws ToolsException	There was an error processing the XML.
	 */
	public static void includeElementValue(Document xml, String xpath, Object value, int type) throws ToolsException {
	 ...
	 * @throws ToolsException	There was an error processing the XML.
	 */
	public static void removeNodes(Document xml, ArrayList<String> nodesToRemove) throws ToolsException {
