 ...
 * @version 1.0, 11/08/2011.
 */
public class StandaloneStatisticPersistenceException extends Exception {
	 ...
	 */
	public StandaloneStatisticPersistenceException(int errorCode, String message) {
		super(message);
		this.code = errorCode;
	 ...
	 */
	public StandaloneStatisticPersistenceException(int errorCode, String message,Throwable cause) {
		super(message,cause);
		this.code = errorCode;
		this.description = message;
	}
