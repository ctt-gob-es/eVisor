 ...
 */
package es.gob.signaturereport.standalone.maudit.statistics.i18n;
...
public final class LanguageStandalone {
	 ...
	 */
	private static ResourceBundle resStandaloneStatistics = null;
	...
	public static void reloadMessagesConfiguration() {
		if (urlClassLoaderMessages != null) {
			...
			resStandaloneStatistics = ResourceBundle.getBundle(BUNDLENAME_STANDALONE_AUDIT, currentLocale, urlClassLoaderMessages);
		}
	}
	 ...
	 */
	public static String getResStandaloneStatistics(String key) {
		return resStandaloneStatistics.getString(key);
	 ...
	 */
	public static String getFormatResStandaloneStatistics(String key, Object[ ] values) {
		return new MessageFormat(resStandaloneStatistics.getString(key), currentLocale).format(values);
	}
