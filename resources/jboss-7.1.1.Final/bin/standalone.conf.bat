...
rem #
set "JAVA_HOME=C:\Archivos de programa\Java\jdk1.6.0_22"
...
set "JAVA_OPTS=%JAVA_OPTS% -Dsun.rmi.dgc.client.gcInterval=3600000 -Dsun.rmi.dgc.server.gcInterval=3600000 -Djava.net.preferIPv4Stack=true -Dfile.encoding=UTF-8"
