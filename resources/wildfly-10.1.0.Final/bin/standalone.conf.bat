...
rem #
rem set "JAVA_HOME=C:\Archivos de programa\Java\jdk1.8.0_131"
...
set "JAVA_OPTS=-Xms256M -Xmx1024M -XX:MetaspaceSize=96M -XX:MaxMetaspaceSize=256m -Dfile.encoding=UTF-8"
